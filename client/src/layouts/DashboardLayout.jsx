...
const NAV_ITEMS = [
  ...
  { to: '/transactions', label: 'Transactions', icon: Receipt, tourId: 'nav-transactions' },
  { to: '/budget', label: 'Budget', icon: Wallet, tourId: 'nav-budget' },
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-slate-950">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        {/* Desktop top bar - the sidebar already carries the brand/nav, so
            this is just a slim strip for the notifications bell. */}
        <header className="hidden items-center justify-end border-b border-slate-200 bg-white px-6 py-2.5 shadow-sm dark:border-slate-800 dark:bg-slate-900 lg:flex">
          <NotificationsBell />
        </header>
